...
import 'package:flutter_coffee_app/Screens/CoffeeDetails.dart';
import 'package:flutter_coffee_app/model/CoffeeMode.dart';

class NewCoffee extends StatelessWidget {
  @override
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: CoffeeModel.demoCoffee.length,
                    ...
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => CoffeeDetails(
                            coffeeModel: CoffeeModel.demoCoffee[index],
                          ),
                        )),
                    child: CoffeeCard(
                      coffeeModel: CoffeeModel.demoCoffee[index],
              ...
              Flexible(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      widget.coffeeModel.rating.toString() + ' / 5',
                    ),
                    Spacer(),
                    InkWell(
                      onTap: () {
